...
def compare_perf_irl(output_file ='rock_demo_from_mdp_irl', demo_from_mdp=True, show=True):
	...
	if demo_from_mdp:
		file_names = ['rock_mdp_fwd', 'rock_mem10_fwd', 'rock_mem10_trajsize10mdp_irl', 'rock_mem10_trajsize10mdp_irl_si', 
						'rock_mem1_trajsize10mdp_irl', 'rock_mem1_trajsize10mdp_irl_si']
		labelMDP = r'$\mathrm{Opt. \ policy \  on \ MDP, \ N=10}$'
	else:
		file_names = ['rock_mdp_fwd', 'rock_mem10_fwd', 'rock_mem10_trajsize10pomdp_irl', 'rock_mem10_trajsize10pomdp_irl_si', 
						'rock_mem1_trajsize10pomdp_irl', 'rock_mem1_trajsize10pomdp_irl_si']
...
if __name__ == '__main__':
	compare_perf_irl(output_file ='rock_demo_from_mdp_irl', demo_from_mdp=True, show=False)
	compare_perf_irl(output_file ='rock_demo_from_pomdp_irl', demo_from_mdp=False, show=True)