...
def compare_perf_irl(output_file ='obstacle_demo_from_mdp_irl', demo_from_mdp=True, show=True):
	...
	labelPOMDP = r'$\mathrm{Opt. \ FSC \  on \ POMDP}$'
	if demo_from_mdp:
		file_names = ['obstacle_mdp_fwd', 'obstacle_mem5_fwd', 'obstacle_mem5_trajsize10mdp_irl', 'obstacle_mem5_trajsize10mdp_irl_si', 
						'obstacle_mem1_trajsize10mdp_irl', 'obstacle_mem1_trajsize10mdp_irl_si']
		labelMDP = r'$\mathrm{Opt. \ policy \  on \ MDP, \ N=10}$'
	else:
		file_names = ['obstacle_mdp_fwd', 'obstacle_mem5_fwd', 'obstacle_mem5_trajsize10pomdp_irl', 'obstacle_mem5_trajsize10pomdp_irl_si', 
						'obstacle_mem1_trajsize10pomdp_irl', 'obstacle_mem1_trajsize10pomdp_irl_si']
		labelPOMDP = r'$\mathrm{Opt. \ FSC \  on \ POMDP, \ M=10, N=10}$'
	labels = [	labelMDP, 
				labelPOMDP,
...
if __name__ == '__main__':
	compare_perf_irl(output_file ='obstacle_demo_from_mdp_irl', demo_from_mdp=True, show=False)
	compare_perf_irl(output_file ='obstacle_demo_from_pomdp_irl', demo_from_mdp=False, show=True)