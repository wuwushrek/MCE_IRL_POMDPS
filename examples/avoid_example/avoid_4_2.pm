...
rewards "avoid"
    [south] !(!crash & !seeagent1 & !seeagent2) : -1;
    [north] !(!crash & !seeagent1 & !seeagent2) : -1;
    [east] !(!crash & !seeagent1 & !seeagent2) : -1;
    [west] !(!crash & !seeagent1 & !seeagent2) : -1;
    [adv] !(!crash & !seeagent1 & !seeagent2) : -1;
endrewards
