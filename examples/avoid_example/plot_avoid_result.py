...
def compare_perf_irl(output_file ='maze_demo_from_mdp_irl', demo_from_mdp=True, show=True):
	...
	if demo_from_mdp:
		file_names = ['avoid_mdp_fwd', 'avoid_mem1_fwd', 'avoid_mem1_trajsize10mdp_irl', 'avoid_mem1_trajsize10mdp_irl_si']
...
if __name__ == '__main__':
	compare_perf_irl(output_file ='avoid_demo_from_mdp_irl', demo_from_mdp=True, show=False)
