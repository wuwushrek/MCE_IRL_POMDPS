...
class POMDP_Gridworld():
    ...
    def __init__(self, n_rows, n_cols, agent_dynamics, slip_probability=0, gamma=0.9, perception_accuracy=0.75):
        pass

    def _construct_observation_space(self, TODO):
        pass

    def _construct_state_space(self, TODO):
        pass

    def _construct_action_space(self, TODO):
        pass

    def _construct_transition_function(self, TODO):
        pass

# Main
if __name__ == "__main__":
    MDP_GridWorld(3, 3, "elementary", 0.2)
    POMDP_Gridworld(3,3, "elementary", 0.2, 0.99, 0.75)
